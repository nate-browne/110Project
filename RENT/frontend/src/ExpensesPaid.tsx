...
export default class ExpensesPaid extends Component {
    ...
    render() {
          return (
            <View>
                <Button style={styles.button} raised={true} titleStyle={styles.text_total} title="Add charge for all" onPress={() => {Alert.alert('TODO: add charge')}}/>
                <ScrollView horizontal={true} style= {{width: '100%', height:'100%', flexDirection: 'row'}}>
                <View style={{height: '95%', flexDirection: 'column', padding: 5}}>
                    <Text style={styles.text_name}> Maria </Text>
                    <Button style={styles.button} raised={true} title="Add Individual charge" onPress={() => {Alert.alert('TODO: add charge')}}/>
